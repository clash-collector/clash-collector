    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The authority that holds the pot"];
          pda: {
            seeds: [
              {
                kind: "const";
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The mint of the token used to pay the entry fee"];
        },
        {
          name: "systemProgram";
          isMut: false;
          isSigner: false;
          docs: ["Solana ecosystem program addresses"];
        },
        {
          name: "rent";
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The token metadata used to verify that the token is part of the collection"];
        },
        {
          name: "potAccount";
          isMut: true;
